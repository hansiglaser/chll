...
setenv UNITS_PATH "../../../../units"
setenv RECONV_PATH "$UNITS_PATH/reconfmodule/chll/out"
setenv APP_NAME    "<AppName>"
setenv APP_NAME_LC "<AppName in lower case>"
...
read design -noelaborate -golden -verbose \
  -verilog2k $APPVLOG_PATH/spifsm.v \
...
read design -noelaborate -revised \
  ...
  -vhdl 93 $RECONV_PATH/trfsm2-wrapper.vhd \
  -vhdl 93 $RECONV_PATH/trfsm3-wrapper.vhd

// compile cell library
read design -noelaborate -revised \
  -verilog2k $CELLLIB_PATH/<cell1>/verilog/<cell1>.v \
  -verilog2k $CELLLIB_PATH/<cell2>/verilog/<cell2>.v
...
// ReconfModule
read design -noelaborate -revised \
  -vhdl 93 $PKG_PATH/utils-p.vhd \
  -vhdl 93 $PKG_PATH/config-p.vhd \
  -vhdl 93 $UNITS_PATH/cfgintf/vhdl/cfgintf.vhd \
  -vhdl 93 $UNITS_PATH/paramintf/vhdl/paramintf.vhd \
  -vhdl 93 $UNITS_PATH/paramintf/vhdl/paramoutreg.vhd \
  -vhdl 93 $RECONV_PATH/reconflogic.vhd
 
// compile top wrapper
read design -noelaborate -revised \
  -vhdl 93 $APPCHLL_PATH/$APP_NAME_LC-wrapreconfmodule-lec.vhd

// elaborate and implement
elaborate design -revised -root $APP_NAME

// apply bitstreams to TR-FSMs
dofile $APPCHLL_PATH/$APP_NAME_LC-reconfmodule-bitstream-lec.do

// access internal parameter registers as primary IOs, deactivate CfgIntf and ParamIntf
dofile $APPCHLL_PATH/$APP_NAME_LC-wrapreconfmodule-lec-setup.do
...
// switch to LEC mode, but don't perform mapping
set system mode lec -nomap

// map internal parameter registers (accessed as added primary IOs) to their original ports
dofile $APPCHLL_PATH/$APP_NAME_LC-wrapreconfmodule-lec-mapping.do

// now map everything else automatically
map key points  

report mapped points             > $RPT_PATH/$APP_NAME_LC-mapped-points.rpt
