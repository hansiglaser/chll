...
read design -noelaborate -revised \
  -vhdl 93 $APPCHLL_PATH/$APP_NAME_LC-fsm<fsm1>-wrapper.vhd \
  -vhdl 93 $APPCHLL_PATH/$APP_NAME_LC-fsm<fsm2>-wrapper.vhd

// compile top (with "$fsm" replaced by wrappers)
read design -noelaborate -revised \
  -verilog $APPCHLL_PATH/$APP_NAME_LC-trfsm.v

// elaborate and implement
elaborate design -revised -root $APP_NAME

// apply bitstreams to TR-FSMs
dofile $APPCHLL_PATH/$APP_NAME_LC-fsm-bitstream-lec.do
...
flatten -golden
dofile $APPCHLL_PATH/$APP_NAME_LC-fsm-encoding-lec.do
