...
read design -noelaborate -golden -verbose \
  -verilog2k $APPVLOG_PATH/<submod1>.v \
  -verilog2k $APPVLOG_PATH/<submod2>.v \
...
read design -noelaborate -revised \
  -vhdl 93 $APPCHLL_PATH/$APP_NAME_LC-extract-<fsm1>-wrapper.vhd \
  -vhdl 93 $APPCHLL_PATH/$APP_NAME_LC-extract-<fsm2>-wrapper.vhd
...
// compile top (with "$fsm" replaced by wrappers)
read design -noelaborate -revised \
  -verilog $APPCHLL_PATH/$APP_NAME_LC-extract-trfsm.v

// elaborate and implement
elaborate design -revised -root $APP_NAME

// apply bitstreams to TR-FSMs
dofile $APPCHLL_PATH/$APP_NAME_LC-extract-bitstream-lec.do
...
flatten -golden
dofile $APPCHLL_PATH/$APP_NAME_LC-extract-encoding-lec.do
