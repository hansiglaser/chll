...
read design -noelaborate -revised \
  -verilog $APPCHLL_PATH/$APP_NAME_LC-extract-intersynth.v

// elaborate and implement
elaborate design -revised -root $APP_NAME

// apply bitstreams to TR-FSMs
dofile $APPCHLL_PATH/$APP_NAME_LC-extract-intersynth-bitstream-lec.do
...
flatten -golden
dofile $APPCHLL_PATH/$APP_NAME_LC-extract-intersynth-encoding-lec.do
