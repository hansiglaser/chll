...
add wave -noupdate [find nets {/max6682_tb/DUT/*fsm*SPI_FSM_State*/next_state} ]
add wave -noupdate [find nets {/max6682_tb/DUT/*fsm*SPI_FSM_State*/state} ]
...
add wave -noupdate -radix unsigned [find nets {/max6682_tb/DUT/*Timer*D_s*} ]
