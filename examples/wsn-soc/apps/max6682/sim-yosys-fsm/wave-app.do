...
add wave -noupdate [find nets {/max6682_tb/DUT/MAX6682_SPI_FSM_1/*fsm*SPI_FSM_State*/next_state} ]
add wave -noupdate [find nets {/max6682_tb/DUT/MAX6682_SPI_FSM_1/*fsm*SPI_FSM_State*/state} ]
...
add wave -noupdate [find nets {/max6682_tb/DUT/*fsm*SensorFSM_State*/next_state} ]
add wave -noupdate [find nets {/max6682_tb/DUT/*fsm*SensorFSM_State*/state} ]
