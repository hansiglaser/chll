...
add wave -noupdate /max6682_tb/DUT/SPI_FSM_Done
add wave -noupdate /max6682_tb/DUT/SPIFSM_1/TRFSM_1/NextState_s
add wave -noupdate /max6682_tb/DUT/SPIFSM_1/TRFSM_1/State_s
add wave -noupdate /max6682_tb/DUT/SPI_FSM_Start
add wave -noupdate /max6682_tb/DUT/SPI_FSM_Wr0
add wave -noupdate /max6682_tb/DUT/SPI_FSM_Wr1
add wave -noupdate -divider SensorFSM
add wave -noupdate -radix unsigned /max6682_tb/DUT/Threshold_i
add wave -noupdate /max6682_tb/DUT/SensorFSM_DiffTooLarge
add wave -noupdate /max6682_tb/DUT/SensorFSM_1/TRFSM_1/NextState_s
add wave -noupdate /max6682_tb/DUT/SensorFSM_1/TRFSM_1/State_s
add wave -noupdate /max6682_tb/DUT/SensorFSM_StoreNewValue
add wave -noupdate -radix unsigned /max6682_tb/DUT/SensorFSM_Timer
...
add wave -noupdate -radix unsigned /max6682_tb/DUT/Word0
