...
add wave -noupdate /core_tb/Enable_i
add wave -noupdate /core_tb/SensorPower_o
add wave -noupdate /core_tb/SensorStart_o
add wave -noupdate /core_tb/SensorReady_i
add wave -noupdate /core_tb/AdcStart_o
add wave -noupdate -radix unsigned /core_tb/AdcValue_i
add wave -noupdate /core_tb/AdcDone_i
...
WaveRestoreCursors {{Cursor 1} {379398446931 ps} 0}
...
update
WaveRestoreZoom {0 ps} {7110600 ps}
