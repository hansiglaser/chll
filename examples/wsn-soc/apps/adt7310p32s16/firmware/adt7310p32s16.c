...
#include "adt7310p32s16.h"
#ifdef WRAPAPP
#  include "adt7310p32s16-wrapapp-driver.h"
#else
#  include "adt7310p32s16-driver.h"
#endif

#ifndef SIMULATION
// delay between start of conversion command and query command, must be >
// 240ms, the value is given in clock cycles
// ADT7310P32S16 only supports 16 bit SPI counter, but we simply use 20000 for
