...
module MAX6682Mean(Reset_n_i, Clk_i, Enable_i, CpuIntr_o, MAX6682CS_n_o, SPI_Data_i, SPI_Write_o, SPI_ReadNext_o, SPI_Data_o, SPI_FIFOFull_i, SPI_FIFOEmpty_i, SPI_Transmission_i, PauseCounterPreset_i, PeriodCounterPresetH_i, PeriodCounterPresetL_i, SensorValue_o, Threshold_i, SPI_CPOL_o, SPI_CPHA_o, SPI_LSBFE_o);
  ...
  wire [3:0] \$10\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$11\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire \$2\PauseTimerPreset[0:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire \$2\SPI_FSM_Start[0:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$2\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire \$2\SensorFSM_TimerPreset[0:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$3\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$4\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$5\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$6\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$7\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$8\SensorFSM_NextState[3:0] ;
  (* src = "../../verilog/max6682mean.v:112" *)
  wire [3:0] \$9\SensorFSM_NextState[3:0] ;
  ...
  (* src = "../../verilog/max6682mean.v:87" *)
  wire [3:0] SensorFSM_NextState;
  (* src = "../../verilog/max6682mean.v:86" *)
  wire [3:0] SensorFSM_State;
  ...
  \$pmux  #(
    .S_WIDTH(32'b00000000000000000000000000001010),
    .WIDTH(32'b00000000000000000000000000000100)
  ) \$procmux$612  (
    .A(SensorFSM_State),
    .B({ \$2\SensorFSM_NextState[3:0] , \$3\SensorFSM_NextState[3:0] , \$5\SensorFSM_NextState[3:0] , \$6\SensorFSM_NextState[3:0] , \$7\SensorFSM_NextState[3:0] , \$8\SensorFSM_NextState[3:0] , \$9\SensorFSM_NextState[3:0] , \$10\SensorFSM_NextState[3:0] , \$11\SensorFSM_NextState[3:0] , 4'b0001 }),
    .S({ \$procmux$1027_CMP , \$procmux$1024_CMP , \$procmux$1019_CMP , \$procmux$1121_CMP , \$procmux$1188_CMP , \$procmux$1325_CMP , \$procmux$1392_CMP , \$procmux$1529_CMP , \$procmux$1596_CMP , \$procmux$1663_CMP  }),
  ...
  \$mux  #(
    ...
    .A(4'b0000),
    .B(\$4\SensorFSM_NextState[3:0] ),
    .S(Enable_i),
    .Y(\$3\SensorFSM_NextState[3:0] )
  );
  \$mux  #(
    .WIDTH(32'b00000000000000000000000000000100)
  ) \$procmux$912  (
...
module SPI_FSM(Reset_n_i, Clk_i, SPI_FSM_Start, SPI_Transmission_i, MAX6682CS_n_o, SPI_Write_o, SPI_ReadNext_o, SPI_FSM_Done, SPI_Data_i, Byte0, Byte1);
  ...
  (* src = "../../verilog/spifsm.v:50" *)
  wire [2:0] \$4\SPI_FSM_NextState[2:0] ;
  ...
  \$pmux  #(
    .S_WIDTH(32'b00000000000000000000000000000110),
    .WIDTH(32'b00000000000000000000000000000011)
  ) \$procmux$1929  (
    .A(SPI_FSM_State),
    .B({ \$2\SPI_FSM_NextState[2:0] , 6'b010011, \$3\SPI_FSM_NextState[2:0] , 3'b101, \$4\SPI_FSM_NextState[2:0]  }),
    .S({ \$procmux$1869_CMP , \$procmux$1866_CMP , \$procmux$1865_CMP , \$procmux$1864_CMP , SPI_FSM_Wr0, SPI_FSM_Done }),
    .Y(SPI_FSM_NextState)
  );
  \$pmux  #(
    .S_WIDTH(32'b00000000000000000000000000000010),
