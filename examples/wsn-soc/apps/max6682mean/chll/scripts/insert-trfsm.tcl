...
set spi_trfsm    [create_trfsm  8 15 5 5 10 10 5 5]
set sensor_trfsm [create_trfsm 10 10 5 5 10 10 5 5]
set TRFSMs [list $spi_trfsm $sensor_trfsm]
set TRFSMShortNames [list "SPIFSM" "SensorFSM"]
