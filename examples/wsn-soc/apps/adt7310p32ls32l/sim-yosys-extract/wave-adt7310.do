...
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/*fsm*SensorFSM_State*/next_state} ]
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/*fsm*SensorFSM_State*/state} ]
add wave -noupdate -radix decimal {/adt7310p32ls32l_tb/DUT/\SensorFSM_1.SensorValue }
add wave -noupdate -radix decimal /adt7310p32ls32l_tb/DUT/SensorValue_o
add wave -noupdate -radix decimal {/adt7310p32ls32l_tb/DUT/\SensorFSM_1.AbsDiffResult }
add wave -noupdate -radix decimal [find nets {/adt7310p32ls32l_tb/DUT/*extract*AbsDiff* /DiffAB} ]
add wave -noupdate -radix decimal [find nets {/adt7310p32ls32l_tb/DUT/*extract*AbsDiff* /DiffBA} ]
...
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/*fsm*SPI_FSM_State*/next_state} ]
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/*fsm*SPI_FSM_State*/state} ]
