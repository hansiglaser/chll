...
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/SensorFSM_1/*fsm*SensorFSM_State*/next_state} ]
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/SensorFSM_1/*fsm*SensorFSM_State*/state} ]
...
add wave -noupdate -radix decimal /adt7310p32ls32l_tb/DUT/SensorFSM_1/DiffAB
add wave -noupdate -radix decimal /adt7310p32ls32l_tb/DUT/SensorFSM_1/DiffBA
add wave -noupdate /adt7310p32ls32l_tb/DUT/SensorFSM_1/SensorFSM_DiffTooLarge
add wave -noupdate -divider SPI-FSM
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/SPIFSM_1/*fsm*SPI_FSM_State*/next_state} ]
add wave -noupdate [find nets {/adt7310p32ls32l_tb/DUT/SPIFSM_1/*fsm*SPI_FSM_State*/state} ]
