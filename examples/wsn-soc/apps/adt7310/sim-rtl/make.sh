...
function CompileUart() {
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/baudgenerator-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/baudgenerator-rtl-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/errorbit-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/errorbit-rtl-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/errorindicator-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/errorindicator-structure-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/rxdatastatemachine-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/rxdatastatemachine-rtl-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/rxmodule-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/rxmodule-structure-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/txdatastatemachine-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/txdatastatemachine-rtl-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/txmodule-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/txmodule-structure-a.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/uart-e.vhd
  vcom ${VCOM_OPTS} -work work -87    $UNITS_PATH/core/tb/uart/uart-structure-a.vhd
}
...
case "$SIM_MODE" in
  ...
  sim-chip-route)
    ...
    ;;
  sim-chip-power)
    # sim-chip-power: chip Post-P&R gate-level netlist simulation for power analysis
    # compile core and pad library
    vlog ${VLOG_OPTS} ${C35_PATH}/udp.v   
    vlog ${VLOG_OPTS} ${C35_PATH}/c35_CORELIB.v
    vlog ${VLOG_OPTS} ${C35_PATH}/c35_IOLIB_4M.v
...
vcom ${VCOM_OPTS} -work work -2002  $APPTEST_PATH/${APP_NAME_LC}-model.vhd
# testbench
if [ -z "${SIM_MODE%%sim-core-*}" ] ; then
  # sim-core-*
  vcom ${VCOM_OPTS} -work work -93    $APPTEST_PATH/core_${APP_NAME_LC}_tb.vhd
elif [ "${SIM_MODE}" = "sim-chip-power" ] ; then
  # sim-chip-power
  vcom ${VCOM_OPTS} -work work -93    $APPTEST_PATH/chip_power_tb.vhd
