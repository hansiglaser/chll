...
app_add_param -in -conntype "Word" -default 0     "WaitCounterPresetH_i"
app_add_param -in -conntype "Word" -default 24000 "WaitCounterPresetL_i"
app_add_param -in -conntype "Word" -default 30    "Threshold_i"
app_add_param -in -conntype "Word" -default 0     "PeriodCounterPresetH_i"
app_add_param -in -conntype "Word" -default 10    "PeriodCounterPresetL_i"
# result value
