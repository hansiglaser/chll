...
read_verilog $VLOG_DIR/i2cfsm.v
read_verilog $VLOG_DIR/sensorfsm.v
...
if { $EXTRACT_FSM == "true" } {
  ...
  opt
  # write KISS files
  select {SlowADT7410/n:*$fsm*I2C_FSM_State*}
  fsm_export -o /tmp/i2cfsm.kiss -origenc
  select -clear
  select {SlowADT7410/n:*$fsm*SensorFSM_State*}
