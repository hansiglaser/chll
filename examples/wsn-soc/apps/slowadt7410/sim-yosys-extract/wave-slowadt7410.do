...
add wave -noupdate [find nets {/slowadt7410_tb/DUT/*fsm*SensorFSM_State*/next_state} ]
add wave -noupdate [find nets {/slowadt7410_tb/DUT/*fsm*SensorFSM_State*/state} ]
...
add wave -noupdate [find nets {/slowadt7410_tb/DUT/*fsm*I2C_FSM_State*/next_state} ]
add wave -noupdate [find nets {/slowadt7410_tb/DUT/*fsm*I2C_FSM_State*/state} ]
...
add wave -noupdate [find nets {/slowadt7410_tb/DUT/*I2CFSM_1*Timer*/Value} ]
