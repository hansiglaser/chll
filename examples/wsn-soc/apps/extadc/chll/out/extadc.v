...
module ExtADC(Reset_n_i, Clk_i, Enable_i, CpuIntr_o, SensorPower_o, SensorStart_o, SensorReady_i, AdcStart_o, AdcDone_i, AdcValue_i, PeriodCounterPreset_i, SensorValue_o, Threshold_i);
  ...
  (* src = "../../verilog/extadc.v:58" *)
  wire [2:0] \$3\NextState[2:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire \$3\TimerEnable[0:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire \$3\TimerPreset[0:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire [2:0] \$4\NextState[2:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire \$4\TimerEnable[0:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire [2:0] \$5\NextState[2:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire [2:0] \$6\NextState[2:0] ;
  (* src = "../../verilog/extadc.v:58" *)
  wire [2:0] \$7\NextState[2:0] ;
  ...
  \$pmux  #(
    ...
    .A(State),
    .B({ \$2\NextState[2:0] , \$3\NextState[2:0] , 3'b011, \$5\NextState[2:0] , \$6\NextState[2:0] , 3'b001 }),
    .S({ \$procmux$202_CMP , \$procmux$199_CMP , \$procmux$194_CMP , \$procmux$193_CMP , \$procmux$190_CMP , CpuIntr_o }),
    .Y(NextState)
  );
  \$mux  #(
    .WIDTH(32'b00000000000000000000000000010000)
