...
vlog ${VLOG_OPTS} -work work        $CELLVLOG_PATH/addsubcmp.v
vlog ${VLOG_OPTS} -work work        $CELLTEST_PATH/addsubcmp-verilog-c.v
vcom ${VCOM_OPTS} -work work -2002  $CELLTEST_PATH/addsubcmp_tb.vhd
