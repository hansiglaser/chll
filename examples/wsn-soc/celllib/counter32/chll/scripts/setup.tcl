...
# preset value
cell_add_port "PresetValH_i" -in  -conntype "Word"
cell_add_port "PresetValL_i" -in  -conntype "Word"
# current value
cell_add_port "DH_o"         -out -conntype "Word"
cell_add_port "DL_o"         -out -conntype "Word"
# flags
