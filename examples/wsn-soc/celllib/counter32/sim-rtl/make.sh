...
# compile all files
vlog ${VLOG_OPTS} -work work        $CELLVLOG_PATH/counter32.v
vlog ${VLOG_OPTS} -work work        $CELLVLOG_PATH/counter32_rv1.v
vcom ${VCOM_OPTS} -work work -2002  $TRFSMTEST_PATH/tbfuncs-p.vhd
vcom ${VCOM_OPTS} -work work -2002  $CELLTEST_PATH/counter32_tb.vhd
