...
FIRMWARE="../firmware/adt7310-cpu/firmware.do"
...
vsim -t 1ps -voptargs="+acc -suppress 2685,2718" -sdf$OPCOND /Chip_ADT7310_tb/DUT=$SDF +sdf_verbose -sdfnoerror Chip_ADT7310_tb
do wave.do
set PMEM_REG sim:/Chip_ADT7310_tb/DUT/core_1/PMem_0/ram_0/memory
do firmware-ram0.do
set PMEM_REG sim:/Chip_ADT7310_tb/DUT/core_1/PMem_0/ram_1/memory
do firmware-ram1.do
set PMEM_REG sim:/Chip_ADT7310_tb/DUT/core_1/PMem_0/ram_2/memory
do firmware-ram2.do
set PMEM_REG sim:/Chip_ADT7310_tb/DUT/core_1/PMem_0/ram_3/memory
do firmware-ram3.do
#log -r /*
run -all
#run 300us
