// taken from OpenMSP430 SVN ./fpga/xilinx_diligent_s3board/software/hw_uart/hardware.h
#ifndef HARDWARE_H
#define HARDWARE_H
...
#define UART_CTL          (*(volatile unsigned char *) 0x0070)  // UART Control register (8bit)
#define UART_STAT         (*(volatile unsigned char *) 0x0071)  // UART Status register (8bit)
#define UART_BAUD         (*(volatile unsigned int  *) 0x0072)  // UART Baud rate configuration (16bit)
#define UART_TXD          (*(volatile unsigned char *) 0x0074)  // UART Transmit data register (8bit)
#define UART_RXD          (*(volatile unsigned char *) 0x0075)  // UART Receive data register (8bit)
